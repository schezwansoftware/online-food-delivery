...
class AddressGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("accountapp:bXktc2VjcmV0LXRva2VuLXRvLWNoYW5nZS1pbi1wcm9kdWN0aW9uLWFuZC10by1rZWVwLWluLWEtc2VjdXJlLXBsYWNl".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Address entity")
        ...
        .formParam("client_id", "accountapp")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "latitude":"SAMPLE_TEXT", "longitude":"SAMPLE_TEXT", "locality":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "userId":"SAMPLE_TEXT", "landmark":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
